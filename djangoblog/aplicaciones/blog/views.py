...
def home(request):
	...
	paginator = Paginator(posts,2)#lista a mostrar, y cuantos articulos mostrar
	#obtener la pagina en custion actual, para saber en que numero de pagina se encuentra
	page = request.GET.get('page')
	''' volvermos a definir la lista , se le asigna lo que tenga paginator'''
	posts = paginator.get_page(page) #get_page() obtiene la pagina, se le pasa la pagina actual
...
def generales(request):
	queryset=request.GET.get("buscar")
	#Validacion si existe la consulta--- sin minuscula o mayuscula
